...
badge="[![React upstream checked](https://img.shields.io/badge/React%20upstream%20checked-${sha:0:8}-informational \"Newest React commit the vendored rule has been compared against\")](https://github.com/$UPSTREAM_REPO/commit/$sha)"
